...
public class Customer extends Person {
    ...
    public Customer(int id, String name, LocalDate dayOfBirth, Boolean gender, long identity, String phoneNumber, String email, String typeOfCustomer, String address) {
